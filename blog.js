// ============================================================
// blog.js - 文章详情页 + Vditor 编辑器（图片上传 + 评论发表）
...
(function() {
  ...
  async function loadDiscussionFull(discussionNumber) {
    try {
      ...
      // 正文（14pt 黑色）
      textEl.innerHTML = `<span style="font-size:14pt; font-family:Arial, Helvetica, sans-serif; color:#000000;">${sanitizeHtml(renderMarkdown(bodyText))}</span>`;
